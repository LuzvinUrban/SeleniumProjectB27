...
public class T5_getText_getAttribute {
    public static void main(String[] args) {
        ...
        if (actualHeader.equals(expectedHeader)) {
            ...
            System.out.println("Header text verficiation passed!");
        } else {
            System.out.println("Header tec verification failed");
...
if(actualPlaceHolder.equals(expectedPlaceHolder)){
    System.out.println("PlcaeHolder text verification!");

}else{
    System.out.println("PlcaeHolder text verification failed!");
}
