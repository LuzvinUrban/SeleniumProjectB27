...
public static String returnOrderDate(WebDriver driver, String costumerName){
    ...
    WebElement customerOderDate = driver.findElement(By.xpath(locator));

   return customerOderDate.getText();


   // String middleName ="Luther";
   // String fullName ="Marthin" + middleName + " King";
